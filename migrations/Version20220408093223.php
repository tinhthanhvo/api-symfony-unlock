 ...
 */
final class Version20220408093223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discount (id INT AUTO_INCREMENT NOT NULL, discount_code VARCHAR(150) NOT NULL, description LONGTEXT DEFAULT NULL, value INT NOT NULL, active_at DATETIME NOT NULL, expire_at DATETIME NOT NULL, create_at DATETIME NOT NULL, update_at DATETIME NOT NULL, delete_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
